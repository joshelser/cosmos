A basic example of how Cosmos can be used, enumerating the different capabilities of Cosmos. All commands assume that they are executed from the directory in
