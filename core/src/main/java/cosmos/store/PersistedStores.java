...
public class PersistedStores {
  ...
  public static void setState(Store id, State state) throws TableNotFoundException, MutationsRejectedException {
    ...
    BatchWriter bw = null;
    try {
      bw = id.connector().createBatchWriter(id.metadataTable(), id.maxWriteMemory(), id.maxWriteLatency(), id.maxWriteThreads());
  ...
  public static void remove(Store id) throws TableNotFoundException, MutationsRejectedException {
    ...
    try {
      bd = id.connector().createBatchDeleter(id.metadataTable(), id.auths(), id.readThreads(), id.maxWriteMemory(), id.maxWriteLatency(), id.maxWriteThreads());
