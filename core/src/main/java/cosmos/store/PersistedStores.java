...
public class PersistedStores {
  ...
  public static void setState(Store id, State state) throws TableNotFoundException, MutationsRejectedException {
    ...
    BatchWriter bw = null;
    try {
      bw = id.connector().createBatchWriter(id.metadataTable(), CosmosImpl.DEFAULT_MAX_MEMORY, CosmosImpl.DEFAULT_MAX_LATENCY, CosmosImpl.DEFAULT_MAX_WRITE_THREADS);
  ...
  public static void remove(Store id) throws TableNotFoundException, MutationsRejectedException {
    ...
    try {
      bd = id.connector().createBatchDeleter(id.metadataTable(), id.auths(), 10, CosmosImpl.DEFAULT_MAX_MEMORY, CosmosImpl.DEFAULT_MAX_LATENCY, CosmosImpl.DEFAULT_MAX_WRITE_THREADS);
