...
public interface AccumuloExpression extends RelNode {
	/**
	 * Calling convention for relational expressions that are "implemented" by
	 * generating Drill logical plans.
	 */
	Convention CONVENTION = new Convention.Impl("COSMOS", AccumuloExpression.class);
	...
	class Implementor {
		...
		public void visitChild(int ordinal, RelNode input) {
			...
			((AccumuloExpression) input).implement(this);
