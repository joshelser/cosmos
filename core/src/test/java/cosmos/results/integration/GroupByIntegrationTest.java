...
public class GroupByIntegrationTest {
  ...
  public static void setupMAC() throws Exception {
    ...
    Connector con = zkInst.getConnector("root", "foo".getBytes());
  ...
  public void setupSorts() throws Exception {
    ...
    con = inst.getConnector("root", "foo".getBytes());
  }
  ...
  public void simpleNonSparseRecordTest() throws Exception {
    ...
    // Testing NAME
    Map<SValue,Long> expects = ImmutableMap.<SValue,Long> of(SValue.create("Josh", cv), 1l, SValue.create("Wilhelm", cv), 1l, SValue.create("Marky", cv), 1l);
    ...
    // TEesting AGE
    expects = ImmutableMap.<SValue,Long> of(SValue.create("24", cv), 1l, SValue.create("25", cv), 1l, SValue.create("29", cv), 1l);
    ...
    // Testing COLOR
    expects = ImmutableMap.<SValue,Long> of(SValue.create("Blue", cv), 2l, SValue.create("Pink", cv), 1l);
