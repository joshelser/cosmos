 ...
 * 
 */
public class CosmosTable extends DataTable<Object[]> {
  
 
  
  public CosmosTable(TableSchema<? extends SchemaDefiner<?>> meataSchema, SchemaDefiner<?> metadata, JavaTypeFactory typeFactory, RelDataType rowType,
      String table) {
